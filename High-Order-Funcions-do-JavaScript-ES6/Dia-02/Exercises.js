...
const getStrongPokemonNames = (arrayPokemons) => arrayPokemons
...
const sortPokemon = (array) => array.sort((a, b) => a.level - b.level);

// console.log(sortPokemons(pokemons));

// EXERCICIO 4

const sortPokemons = (arrayPoke) => arrayPoke.sort(({level: aLevel, name: aName}, {level: bLevel, name: bName}) => {
    if (aLevel === bLevel) {
